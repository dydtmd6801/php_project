    ...
    <?php include "header.php"; ?>
       ...
       <div>
            <div class="review-top-menu">
                ...
                <a style="color: purple; text-decoration: underline;">전시 리뷰</a>
                    ...
                    <li class="data_zone">
                        ...
                        <div>
                            ...
                            if(!$heart_check_sql_result_num){
                                ?>
                                <img src="./img/heart_empty.png" onclick="location.href='like_up.php?num=<?=$num?>&gubun=<?=$gubun?>&page=<?=$page?>&goPage=\'dp\''">
                                <?php
                            } else {
                            ?>
                                <img src="./img/heart.png" onclick="location.href='like_up.php?num=<?=$num?>&gubun=<?=$gubun?>&page=<?=$page?>&goPage=\'dp\''">
                            <?php
                            }
                            ?>
                            </div>
                        ...
                        <div class="review_sub_content">
                            <span><a href="review_show_detail.php?subject=<?=$subject?>&nickname=<?=$nickname?>&page=<?=$page?>&goPage='dp'">상세보기</a></span>
                            <span>
                                <?php
                                if($gubun == "DP"){
                                    echo "전시";
