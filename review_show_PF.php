    ...
    <?php include "header.php"; ?>
       ...
       <div>
            <div class="review-top-menu">
                ...
                <a style="color: purple; text-decoration: underline;">연극 리뷰</a>
            ...
            ?>
            <div class="result_text">연극 리뷰 <span><?=$review_cnt?></span>건</div>
        </div>
                ...
                ?>
                    <li class="data_zone">
                        ...
                        <div class="review_sub_content">
                            <span><a href="review_show_detail.php?subject=<?=$subject?>&nickname=<?=$nickname?>&page=<?=$page?>&goPage='pf'">상세보기</a></span>
                            <span>
                                <?php
                                if($gubun == "DP"){
                                    echo "전시";
        ...
        <ul class="page_num">
            ...
            if ($total_page>=2 && $page >= 2)	
            {
                $new_page = $page-1;
                ?>
                    <form action="review_show_PF.php?page=1" method="post">
                        <button type="submit" class="change_page">◀ 처음</button>
                    </form>
                    <form action="review_show_PF.php?page=<?=$new_page?>" method="post">
                ...
                for ($i = $show_start_page_num; $i <= $show_page_num; $i++){
                    if ($page == $i) {
                        ...
                        ?>
                            <form action="review_show_PF.php?page=<?=$i?>" method="post">
                ...
                if ($total_page>=2 && $page != $total_page){
                    ...
                    <form action="review_show_PF.php?page=<?=$total_page?>" method="post">
